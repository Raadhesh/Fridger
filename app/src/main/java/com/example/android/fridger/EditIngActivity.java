...
public class EditIngActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_ing);

        btnSave = (Button) findViewById(R.id.ing_btnSave);
        btnDelete = (Button) findViewById(R.id.ing_btnDelete);
        editable_item = (EditText) findViewById(R.id.ing_editable_item);
    ...
    private void toastMessage(String message) {
        Toast.makeText(EditIngActivity.this, message, Toast.LENGTH_SHORT).show();
    }
}
